...
class Inputs:
    def __init__(self) -> None:
        ...
        self.df_cmi = pd.read_excel(NAME_DF_DATA_CMI, usecols="A,B,C", engine="openpyxl")
        if not self.isAutomatic and self._numberOption==4:
    ...
    def _getAutomaticOutputs(self):
        ...
        self.df_export=pd.read_excel(os.path.join(NAME_FOLDER_OUTPUTS, self._ficheros[self._numberOption-1],'Formato_2.11_'+self._ficheros[self._numberOption-1]+'_export.xlsx'), engine="openpyxl")
